...
```
Note:
If a test is failed, check the logs for the specific run pipeline, View failed test logs in build pipeline summary, in more actions you can download complete logs which include additional diagnostic information.
```
